...
public class Scalars {
  ...
  public static final GraphQLScalarType GraphQLUuid =
  ...
  public static final GraphQLScalarType GraphQLUri =
      new GraphQLScalarType(
          "URI",
          "URI String",
          new Coercing() {
  ...
  public static final GraphQLScalarType GraphQLUrl =
      new GraphQLScalarType(
          "URL",
          "URL String",
          new Coercing() {
              ...
              if (input instanceof String) {
                try {
                  ...
                  throw new CoercingParseValueException(
                      "Input string \"" + input + "\" could not be parsed into a URL", e);
                }
              }
  ...
  public static final GraphQLScalarType GraphQLBase64String =
      new GraphQLScalarType(
          "Base64String",
  ...
  public static final GraphQLScalarType GraphQLClass =
      new GraphQLScalarType(
          "Class",
  ...
  public static final GraphQLScalarType GraphQLLocale =
      new GraphQLScalarType(
          "Locale",
          "Built-in Locale",
          new Coercing() {
  ...
  public static final GraphQLScalarType GraphQLSqlDate =
      temporalScalar(
          java.sql.Date.class,
          "SqlDate",
          "a SQL compliant local date",
          s -> java.sql.Date.valueOf(LocalDate.parse(s)),
          i -> java.sql.Date.valueOf(i.atZone(ZoneOffset.UTC).toLocalDate()),
          d -> d.toLocalDate().toString());
  public static final GraphQLScalarType GraphQLSqlTime =
      temporalScalar(
          Time.class,
          "SqlTime",
          "a SQL compliant local time",
          s -> Time.valueOf(LocalTime.parse(s)),
          i -> Time.valueOf(i.atZone(ZoneOffset.UTC).toLocalTime()),
          t -> t.toLocalTime().toString());
  public static final GraphQLScalarType GraphQLSqlTimestamp =
      temporalScalar(
          Timestamp.class,
          "SqlTimestamp",
          "a SQL compliant local date-time",
          s -> Timestamp.from(Instant.parse(s)),
          Timestamp::from,
          t -> t.toInstant().toString());
  public static final GraphQLScalarType GraphQLCalendar =
      temporalScalar(
          Calendar.class,
          "Calendar",
          "a date-time with a time-zone",
          s -> GregorianCalendar.from(ZonedDateTime.parse(s)),
          i -> GregorianCalendar.from(i.atZone(ZoneOffset.UTC)),
          c -> c.toInstant().toString());
  public static final GraphQLScalarType GraphQLInstant =
      temporalScalar(Instant.class, "Instant", "an instant in time", Instant::parse, i -> i);
  public static final GraphQLScalarType GraphQLLocalDate =
      temporalScalar(
          LocalDate.class,
          "LocalDate",
          "a local date",
  ...
  public static final GraphQLScalarType GraphQLLocalTime =
      temporalScalar(
          LocalTime.class,
          "LocalTime",
          "a local time",
  ...
  public static final GraphQLScalarType GraphQLZonedDateTime =
      temporalScalar(
          ZonedDateTime.class,
          "ZonedDateTime",
          "a date-time with a time-zone",
          ZonedDateTime::parse,
          i -> i.atZone(ZoneOffset.UTC));
  public static final GraphQLScalarType GraphQLOffsetTime =
      temporalScalar(
          OffsetTime.class,
          "OffsetTime",
          "a time with a UTC offset",
          OffsetTime::parse,
          i -> OffsetTime.ofInstant(i, ZoneOffset.UTC));
  public static final GraphQLScalarType GraphQLOffsetDateTime =
      temporalScalar(
          OffsetDateTime.class,
          "OffsetDateTime",
          "a date-time with a UTC offset",
          OffsetDateTime::parse,
          i -> i.atOffset(ZoneOffset.UTC));
  public static final GraphQLScalarType GraphQLDurationScalar =
      temporalScalar(
          Duration.class,
          "Duration",
          "an amount of time",
          Duration::parse,
          instant -> Duration.ofMillis(instant.toEpochMilli()));
  public static final GraphQLScalarType GraphQLPeriodScalar =
      temporalScalar(
          Period.class,
          "Period",
          "a period of time",
  ...
  private static Coercing OBJECT_SCALAR_COERCION =
      new Coercing<Object, Object>() {
        ...
        public Object serialize(Object dataFetcherResult) {
          ...
          return scalar != null
              ? scalar.getCoercing().serialize(dataFetcherResult)
              : dataFetcherResult;
        }
  ...
  private static String dateToString(Date date) {
    if (Date.class.equals(date.getClass())) {
      ...
      throw serializationException(
          date, Date.class, java.sql.Date.class, Time.class, Timestamp.class);
    }
  }
  ...
  private static Object parseObjectValue(Value value, Map<String, Object> variables) {
    ...
    if (value instanceof ObjectValue) {
      ...
      ((ObjectValue) value)
          .getObjectFields()
          .forEach(
              field -> map.put(field.getName(), parseObjectValue(field.getValue(), variables)));
      return map;
    }
    // Should never happen
    throw new CoercingParseLiteralException(
  ...
  public static <T> GraphQLScalarType temporalScalar(
      Class<T> type,
      String name,
      String description,
      ThrowingFunction<String, T> fromString,
      ThrowingFunction<Instant, T> fromDate) {
  ...
  public static <T> GraphQLScalarType temporalScalar(
    ...
    return new GraphQLScalarType(
        name,
        "Built-in scalar representing " + description,
        new Coercing() {
            ...
            if (type.isInstance(dataFetcherResult)) {
              try {
                ...
                throw new CoercingSerializeException(
                    "Value " + dataFetcherResult + " could not be serialized");
              }
            }
          ...
          public Object parseValue(Object input) {
            try {
              ...
              throw new CoercingParseValueException(
                  "Value " + input + " could not be parsed into a " + name);
            }
          }
          ...
          public T parseLiteral(Object input) {
            try {
              if (input instanceof StringValue) {
                ...
                return fromDate.apply(
                    Instant.ofEpochMilli(((IntValue) input).getValue().longValue()));
              } else {
  ...
  public static CoercingSerializeException serializationException(
      Object input, Class... allowedTypes) {
