...
import io.github.graphqly.reflector.execution.complexity.ComplexityAnalysisInstrumentation;
import io.github.graphqly.reflector.execution.complexity.JavaScriptEvaluator;
  ...
  private ExecutionInput wrapContext(ExecutionInput executionInput) {
    return executionInput.getContext() instanceof GraphQLContext
        ...
        : executionInput.transform(
            builder -> builder.context(new ContextWrapper(executionInput.getContext())));
  }
