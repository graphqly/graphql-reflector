...
public class ExtensionList<E> extends ArrayList<E> {
  ...
  @SafeVarargs
  public final ExtensionList<E> insertAfterOrAppend(
      Class<? extends E> extensionType, E... extensions) {
  ...
  @SafeVarargs
  public final ExtensionList<E> insertBeforeOrPrepend(
      Class<? extends E> extensionType, E... extensions) {
    int firstIndexOfType = firstIndexOfType(extensionType);
  ...
  private int firstIndexOfTypeStrict(Class<? extends E> extensionType) {
    ...
    if (firstIndexOfType < 0) {
      throw new ConfigurationException(
          "Extension of type " + extensionType.getName() + " not found");
    }
