...
public class PageFactory {
  ...
  public static <N> Page<N> createOffsetBasedPage(List<N> nodes, long count, long offset) {
    return createOffsetBasedPage(
        nodes, offset, hasNextPage(nodes.size(), count, offset), hasPreviousPage(count, offset));
  }

  public static <N> Page<N> createOffsetBasedPage(
      List<N> nodes, long offset, boolean hasNextPage, boolean hasPreviousPage) {
  ...
  public static <N, P extends Page<N>> P createOffsetBasedPage(
      List<N> nodes, long count, long offset, BiFunction<List<Edge<N>>, PageInfo, P> pageCreator) {
  ...
  public static <N, E extends Edge<N>, C extends Connection<E>> C createOffsetBasedConnection(
    ...
    return connectionCreator.apply(
        edges,
        createPageInfo(
            edges, hasNextPage(nodes.size(), count, offset), hasPreviousPage(count, offset)));
  }
  ...
  public static <N, E extends Edge<N>> PageInfo createOffsetBasedPageInfo(
      List<E> edges, long count, long offset) {
    return createPageInfo(
        edges, hasNextPage(edges.size(), count, offset), hasPreviousPage(count, offset));
  }
