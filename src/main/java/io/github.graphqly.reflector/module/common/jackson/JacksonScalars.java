...
import static io.github.graphqly.reflector.util.Scalars.*;

@SuppressWarnings("WeakerAccess")
public class JacksonScalars {

  public static final GraphQLScalarType JsonTextNode =
  ...
  public static final GraphQLScalarType JsonBinaryNode =
      new GraphQLScalarType(
          "JsonBase64Binary",
          "Base64-encoded binary JSON node",
          new Coercing() {
            ...
            public Object parseLiteral(Object input) {
              return new BinaryNode(
                  decoder.decode(literalOrException(input, StringValue.class).getValue()));
            }
          });

  public static final GraphQLScalarType JsonBooleanNode =
      new GraphQLScalarType(
          "JsonBoolean",
          "Boolean JSON node",
          new Coercing() {
  ...
  public static final GraphQLScalarType JsonDecimalNode =
      new GraphQLScalarType(
          "JsonNumber",
          "Decimal JSON node",
          new Coercing() {
            ...
            public Object parseLiteral(Object input) {
              if (input instanceof IntValue) {
                ...
                throw new CoercingParseLiteralException(
                    errorMessage(input, IntValue.class, FloatValue.class));
              }
            }
          });

  public static final GraphQLScalarType JsonIntegerNode =
      new GraphQLScalarType(
          "JsonInteger",
          "Integer JSON node",
          new Coercing() {
  ...
  public static final GraphQLScalarType JsonBigIntegerNode =
      new GraphQLScalarType(
          "JsonBigInteger",
          "BigInteger JSON node",
          new Coercing() {
  ...
  public static final GraphQLScalarType JsonShortNode =
      new GraphQLScalarType(
          "JsonShort",
          "Short JSON node",
          new Coercing() {
            ...
            public Object parseValue(Object input) {
              if (input instanceof Number || input instanceof String) {
                try {
                  ...
                  throw new CoercingParseValueException(
                      input + " does not fit into a short without a loss of precision");
                }
              }
  ...
  public static final GraphQLScalarType JsonFloatNode =
      new GraphQLScalarType(
          "JsonFloat",
          "Float JSON node",
          new Coercing() {
  ...
  public static final GraphQLScalarType JsonDoubleNode =
      new GraphQLScalarType(
          "JsonDouble",
          "Double JSON node",
          new Coercing() {
