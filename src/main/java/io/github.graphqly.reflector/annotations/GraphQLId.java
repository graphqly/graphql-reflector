 ...
 *
 * <p>NOTE: Due to the lack of support for {@code AnnotatedType} in <i>all</i> JSON libraries for
 * Java, {@link ElementType#TYPE_USE} annotations on input field types or nested operation argument
 * types are lost. Thus, such annotations can only safely be used on top-level argument or output
 * types.
 */
