...
public class PropertyOperationInfoGenerator extends AnnotatedOperationInfoGenerator {
  ...
  public String name(OperationInfoGeneratorParams params) {
    ...
    Optional<String> field =
        Utils.extractInstances(elements, Field.class).findFirst().map(Field::getName);
    Optional<String> getter =
        Utils.extractInstances(elements, Method.class)
            .findFirst()
            .map(ClassUtils::getFieldNameFromGetter);
