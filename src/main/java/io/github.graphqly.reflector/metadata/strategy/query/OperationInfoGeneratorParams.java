...
import io.github.graphqly.reflector.metadata.messages.EmptyMessageBundle;
...
public class OperationInfoGeneratorParams {
  ...
  public static class Builder {
    ...
    public OperationInfoGeneratorParams build() {
      return new OperationInfoGeneratorParams(
          element, declaringType, instanceSupplier, messageBundle, operationType);
    }
  }
}
